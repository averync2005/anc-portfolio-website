  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          placeholder="What's on your mind? Whether you want to collaborate, have an opportunity to share, or just have a question, I want to hear it."
          id="content"
          required
          maxLength={1200}
          value={message}
        ...
        <div className="flex justify-between items-center">
          <p className="text-sm text-muted-foreground">
            Your information is only used to get back to you. Nothing else.
          </p>
          {message.length > 0 && (
            <p className={`text-xs tabular-nums ${message.length >= 1100 ? "text-destructive" : "text-muted-foreground"}`}>
              {message.length}/1200
            </p>
          )}
        </div>
